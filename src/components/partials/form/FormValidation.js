                ...
                <Row className='g-gs'>
                    <Col md='6'>
                        <div className='form-group'>
                            ...
                            <div className='form-control-wrap'>
                                <input type='text' id='fv-full-name' {...register('fullname', { required: true })} className='form-control' />
                    ...
                    <Col md='6'>
                        <div className='form-group'>
                            ...
                            <div className='form-control-wrap'>
                                <input type='text' id='fv-subject' {...register('subject', { required: true })} className='form-control' />
                    ...
                    <Col md='12'>
                        <div className='form-group'>
                            ...
                            <ul className='custom-control-group g-3 align-center'>
                                ...
                                <li>
                                    <div className='custom-control custom-checkbox'>
                                        <input type='checkbox' className='custom-control-input' id={id + ' fv-com-phone'} name='com' value='phone' />
