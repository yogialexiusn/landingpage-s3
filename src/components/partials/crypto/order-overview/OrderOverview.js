                        ...
                        <Row className='g-4'>
                            <Col xxl='12' sm='6'>
                                <div className='nk-order-ovwg-data buy'>
                                    ...
                                    <div className='info'>
                                        ...
                                        <strong>
                                            {orderOverview === 'set2' ? '39,000' : '14,050'} <span className='currenct currency-usd'>USD</span>
                                        </strong>
                                    </div>
                                    <div className='title'>
                            ...
                            <Col xxl='12' sm='6'>
                                <div className='nk-order-ovwg-data sell'>
                                    <div className='amount'>
                                        {orderOverview === 'set2' ? '18,920' : '10,820'} <small className='currenct currency-usd'>USD</small>
                                    </div>
                                    <div className='info'>
                                        Last {orderOverview === 'set2' ? '30' : '15'} days{' '}
                                        <strong>
                                            {orderOverview === 'set2' ? '39,258' : '18,365'} <span className='currenct currency-usd'>USD</span>
                                        </strong>
                                    </div>
                                    <div className='title'>
