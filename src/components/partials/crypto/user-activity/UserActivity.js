            ...
            <div className='card-inner'>
                ...
                <div className='user-activity-group g-4'>
                    <div className='user-activity'>
                        ...
                        <div className='info'>
                            <span className='amount'> {userActivity === 'day' ? '345' : userActivity === 'month' ? '850' : '50'}</span>
