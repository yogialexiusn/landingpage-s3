                ...
                <div className='card-tools'>
                    <UncontrolledDropdown>
                        <DropdownToggle tag='div' color='transparent'>
                            <a href='#toggle' onClick={(ev) => ev.preventDefault()} className='btn btn-primary btn-dim d-none d-sm-inline-flex'>
                                <Icon className='d-none d-sm-inline' name='download-cloud' />
                                <span>
                                    <span className='d-none d-md-inline'>Download</span> Report
                                </span>
                            </a>
                            <a href='#toggle' onClick={(ev) => ev.preventDefault()} className='btn btn-primary btn-icon btn-dim d-sm-none'>
